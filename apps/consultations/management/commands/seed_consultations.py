...
HUB = {
    ...
    "home_faq_label": "سوالات متداول",
    "home_faq_title": "سوالات متداول",
    "home_faq_description": "قبل از مراجعه باید بدونی …",
...
CATEGORIES = [
    {
        ...
        **gate_copy(
        ...
        "faqs": [
            {
                "question": "چه زمانی پیش از مراسم برای مشاوره اقدام کنم؟",
                "answer": (
                    "برای مراسم بهتر است چند روز تا چند هفته زودتر اقدام کنید تا زمان کافی برای انتخاب خدمت و هماهنگی داشته باشید."
                ),
                "sort_order": 1,
            },
            {
                "question": "خدمات را صالح انجام می‌دهد یا اعضای تیم؟",
                "answer": (
                    "بسته به نوع خدمت، اجرا توسط صالح یا عضو تخصصی تیم انجام می‌شود و هنگام رزرو شفاف اعلام خواهد شد."
                ),
                "sort_order": 2,
            },
            {
                "question": "مشاوره حضوری است یا تلفنی؟ هزینه دارد؟",
                "answer": (
                    "مشاوره می‌تواند حضوری یا تلفنی انجام شود؛ شیوه و هزینه آن پیش از ثبت نهایی به شما اعلام می‌شود."
                ),
                "sort_order": 3,
            },
        ],
    },
    {
        ...
        **gate_copy(
        ...
        "faqs": [
            {
                "question": "روز نوبت، چه ساعتی در سالن حاضر باشم؟",
                "answer": (
                    "۱۵ دقیقه پیش از زمان نوبت در سالن حاضر باشید تا بدون عجله آماده شروع خدمت شوید."
                ),
                "sort_order": 1,
            },
            {
                "question": "هزینه درج‌شده شامل چه مواردی است؟",
                "answer": "هزینه شامل همان خدمت و مراحلی است که در توضیحات آن نوشته شده؛ موارد اضافه پیش از اجرا با شما هماهنگ می‌شود.",
                "sort_order": 2,
            },
            {
                "question": "تغییر یا لغو نوبت چگونه انجام می‌شود؟",
                "answer": "از طریق تماس با سالن یا پیگیری رزرو، هرچه زودتر اطلاع دهید تا امکان جابه‌جایی زمان بررسی شود.",
                "sort_order": 3,
            },
        ],
    },
    {
        ...
        **gate_copy(
        ...
        "faqs": [
            {
                "question": "اگر خدمت مناسب را نمی‌دانم، از کجا شروع کنم؟",
                "answer": (
                    "از صفحه مشاوره شروع کنید یا پیش از رزرو با ما تماس بگیرید تا بر اساس نیاز و زمان شما مسیر مناسب پیشنهاد شود."
                ),
                "sort_order": 1,
            },
            {
