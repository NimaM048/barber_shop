...
DEFAULTS = {
    "hero_eyebrow": "سالن تخصصی آقایان در اصفهان",
    "hero_title": "صالح ایوبی",
    "hero_tagline": "از طراحی مو و ریش تا فیشیال، مراقبت پوست سر و آماده‌سازی داماد؛",
