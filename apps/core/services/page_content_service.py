...
BOOKING_UI_DEFAULTS = {
    ...
    "step1_title": "انتخاب سرویس",
    "step1_sub": "یکی از مسیرهای رزرو را انتخاب کنید",
    "services_empty_title": "در حال حاضر سرویسی برای رزرو فعال نیست.",
    "services_empty_copy": "لطفاً بعداً دوباره سر بزنید.",
    "services_error": "خطا در دریافت سرویس‌ها",
    "retry": "تلاش مجدد",
    "gate_back": "بازگشت به انتخاب سرویس",
    "gate_phase_1": "سرویس انتخاب شد",
