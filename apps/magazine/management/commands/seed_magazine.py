...
TAGS = [
    ...
    ("موی چرب", "oily-hair"),
    ("اصفهان", "isfahan"),
    ("آرایشگاه داماد", "groom-salon"),
]

ARTICLES = [
    {
        "title": "راهنمای کامل آمادگی داماد در اصفهان؛ از سه ماه قبل تا روز مراسم",
        "subtitle": "چک‌لیست حرفه‌ای برای ظاهری بی‌نقص در مهم‌ترین روز زندگی",
        "slug": "groom-preparation-complete-guide",
        "excerpt": (
            "آمادگی داماد در اصفهان فقط یک اصلاح ساده نیست؛ فرآیندی برنامه‌ریزی‌شده "
            "برای پوست، مو، ریش و استایل که نتیجه نهایی را تعیین می‌کند."
        ),
        "category": "groom",
        "tags": ["groom-tag", "skin-care", "daily-routine", "isfahan", "groom-salon"],
        "reading_minutes": 9,
        "is_hero": True,
        "is_featured": True,
        ...
        "cover_image_alt": "آماده‌سازی حرفه‌ای داماد در اصفهان — اصلاح نهایی پیش از مراسم",
        "meta_title": "آمادگی داماد در اصفهان | راهنمای کامل",
        "meta_description": (
            "چک‌لیست آمادگی داماد در اصفهان از سه ماه قبل تا روز مراسم — پوست، مو، ریش و استایل در صالح ایوبی."
        ),
        "body": """
<p>روز مراسم، نقطه اوج ماه‌ها برنامه‌ریزی است. ظاهر داماد باید آرام، مرتب و هماهنگ با استایل مراسم باشد — نه عجولانه و نه تصادفی. در اقلیم خشک اصفهان، مراقبت پوست و زمان‌بندی اصلاح اهمیت بیشتری دارد.</p>
...
<ul>
  ...
  <li>تست محصولات جدید — حداقل شش هفته قبل</li>
</ul>
...
<p>جلسه آزمایشی کوتاهی و اصلاح در استودیوی تخصصی داماد، بهترین راه برای اطمینان از هماهنگی استایل با کت و شلوار و نور عکاسی است.</p>
...
<p>اگر به راهنمایی شخصی‌سازی‌شده نیاز دارید، <a href="/consultations/groom/">مشاوره داماد</a> یا <a href="/appointments/new/?service=groom">رزرو نوبت داماد</a> را از مجموعه صالح ایوبی در اصفهان دنبال کنید.</p>
""",
    },
    {
        "title": "روتین مراقبت پوست مردانه در اقلیم خشک اصفهان",
        "subtitle": "چهار قدم ساده برای پوست شهری و آب‌وهوای خشک",
        "slug": "mens-skincare-routine-four-steps",
        "excerpt": (
            "مراقبت پوست مردانه در اصفهان نیازی به پیچیدگی ندارد؛ ثبات در چهار قدم پایه‌ای، "
            "تفاوت واقعی در برابر خشکی هوا ایجاد می‌کند."
        ),
        "category": "skin",
        "tags": ["skin-care", "daily-routine", "isfahan"],
        "reading_minutes": 6,
        "is_featured": True,
        "display_priority": 80,
        "cover_image_static": "images/brand/hero-groom-2-hd.jpg",
        "meta_title": "مراقبت پوست مردانه در اصفهان",
        "meta_description": (
            "روتین چهار قدمی مراقبت پوست مردانه برای اقلیم خشک اصفهان — پاکسازی، آبرسانی، مرطوب‌کننده و ضدآفتاب."
        ),
        "body": """
<p>پوست مردانه معمولاً ضخیم‌تر است و به دلیل اصلاح، بیشتر در معرض تحریک قرار می‌گیرد. در اصفهان با هوای نسبتاً خشک، آبرسانی و ضدآفتاب اهمیت دوچندان دارد.</p>
<h2>۱. پاکسازی</h2>
...
<h2>۴. ضدآفتاب</h2>
<p>مهم‌ترین قدم ضدپیری. در فضای باز اصفهان، SPF مناسب را فراموش نکنید.</p>
<div class="mag-callout">برای انتخاب محصول متناسب با نوع پوست، <a href="/consultations/skin/">مشاوره پوست</a> یا <a href="/appointments/new/?service=skin">رزرو خدمات پوست</a> را در صالح ایوبی ببینید.</div>
""",
    },
    {
        ...
        "category": "trends",
        "tags": ["trend-2026", "haircut", "isfahan"],
        "reading_minutes": 5,
        "is_featured": True,
        "is_editors_pick": True,
        "display_priority": 70,
        "cover_image_static": "images/brand/hero-cinematic.jpg",
        "meta_title": "ترند کوتاهی موی مردانه ۲۰۲۶",
        "meta_description": "ترندهای کوتاهی موی مردانه ۲۰۲۶ — بافت کنترل‌شده و خطوط تمیز، مناسب جلسات و مراسم در اصفهان.",
        "body": """
...
<p>برای اجرای دقیق این فرم‌ها می‌توانید از <a href="/services/">کاتالوگ خدمات</a> صالح ایوبی در اصفهان شروع کنید.</p>
""",
    },
    {
...
<h2>۲۴ ساعت اول</h2>
<ul>
  <li>از آرایش و محصولات فعال (رتینول، اسید) پرهیز کنید</li>
...
""".replace("<لی>", "<li>"),
    },
    {
        ...
        "subtitle": "راهنمای انتخاب هوشمند خدمات در استودیوی تخصصی",
        "slug": "how-to-choose-vip-service",
        "excerpt": "انتخاب سرویس مناسب در اصفهان، ترکیبی از هدف زیبایی، زمان در دسترس و سطح مراقبت مورد نیاز است.",
        "category": "services-guide",
        "tags": ["haircut", "beard", "isfahan"],
        "reading_minutes": 5,
        "display_priority": 50,
        "cover_image_static": "images/brand/hero-cinematic.jpg",
        "cover_image_alt": "فضای آرام سالن اصفهان — انتخاب هوشمند خدمات زیبایی",
        "meta_title": "انتخاب سرویس VIP زیبایی در اصفهان",
        "meta_description": "راهنمای انتخاب سرویس VIP در صالح ایوبی اصفهان — تفاوت با داماد و پوست، و زمان مناسب رزرو.",
        "body": """
...
<p><a href="/consultations/vip/">مشاوره VIP</a> را بخوانید یا مستقیم <a href="/appointments/new/?service=vip">نوبت VIP</a> رزرو کنید.</p>
""",
    },
    {
...
""",
    ...
    {
        "title": "آرایشگاه داماد در اصفهان؛ چه معیارهایی مهم است؟",
        "subtitle": "راهنمای انتخاب استودیوی تخصصی برای روز مراسم",
        "slug": "groom-barbershop-isfahan-guide",
        "excerpt": (
            "انتخاب آرایشگاه داماد در اصفهان باید بر پایه تخصص، زمان‌بندی، مشاوره قبل از مراجعه "
            "و هماهنگی ظاهر با مراسم باشد — نه فقط قیمت یا نزدیکی."
        ),
        "category": "groom",
        "tags": ["groom-tag", "groom-salon", "isfahan"],
        "reading_minutes": 6,
        "is_featured": True,
        "is_editors_pick": True,
        "display_priority": 95,
        "cover_image_static": "images/brand/hero-cinematic-frame.jpg",
        "cover_image_alt": "استودیوی تخصصی داماد در اصفهان — صالح ایوبی",
        "meta_title": "آرایشگاه داماد اصفهان | معیارهای انتخاب",
        "meta_description": (
            "معیارهای انتخاب آرایشگاه داماد در اصفهان — تخصص، جلسه آزمایشی، مراقبت پوست و رزرو آنلاین در صالح ایوبی."
        ),
        "body": """
<p>روز عروسی فرصت آزمون و خطا نیست. انتخاب آرایشگاه داماد در اصفهان باید دقیق، تخصصی و قابل برنامه‌ریزی باشد.</p>
<h2>۱. تخصص واقعی در داماد</h2>
<p>سالن عمومی با یک صندلی خالی کافی نیست. به دنبال استودیویی باشید که پروتکل داماد، جلسه آزمایشی و هماهنگی با عکاسی را جدی بگیرد.</p>
<h2>۲. مشاوره قبل از مراجعه</h2>
<p>آمادگی پوست، خواب، محصولات و زمان حضور باید از قبل شفاف باشد. راهنمای مشاوره داماد این مسیر را کوتاه می‌کند.</p>
<h2>۳. زمان‌بندی شفاف و رزرو آنلاین</h2>
<p>نوبت دقیق، بدون انتظار و قابل پیگیری، استرس روز مراسم را کم می‌کند.</p>
<h2>۴. موقعیت و دسترسی در اصفهان</h2>
<p>دسترسی آسان در روز مراسم اهمیت دارد؛ سالن صالح ایوبی در مشتاق اول، خیابان ابوالحسن اصفهانی قرار دارد.</p>
<div class="mag-callout">
  مسیر پیشنهادی:
  <a href="/consultations/groom/">مشاوره داماد</a> →
  <a href="/services/">مشاهده خدمات</a> →
  <a href="/appointments/new/?service=groom">رزرو نوبت</a>
</div>
""",
    },
]
    ...
    def handle(self, *args, **options):
        ...
        for item in ARTICLES:
            ...
            article, was_created = Article.objects.update_or_create(
                ...
                defaults={
                    ...
                    "meta_title": (item.get("meta_title") or item["title"])[:70],
                    "meta_description": (item.get("meta_description") or item["excerpt"])[:170],
                    "meta_keywords": "، ".join(
        ...
        if "groom-preparation-complete-guide" in by_slug:
            ...
            related = [
                by_slug[s]
                for s in (
                    "groom-barbershop-isfahan-guide",
        ...
        if "groom-barbershop-isfahan-guide" in by_slug:
            a = by_slug["groom-barbershop-isfahan-guide"]
            related = [
                by_slug[s]
                for s in (
                    "groom-preparation-complete-guide",
                    "how-to-choose-vip-service",
                    "mens-skincare-routine-four-steps",
                )
                if s in by_slug
